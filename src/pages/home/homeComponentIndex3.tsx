	...
	constructor(props: any) {
		...
		this.state = {
			...
			slides: [
				...
				{
					index: 3, smallIndex: uniqueSmallIndex,
	...
	comfortSection2SplitterMove(event) {
		if (this.isDown) {
			...
			if (
				...
				this.mask1Inner.current.style.backdropFilter = `blur(${Math.abs(40 - Math.abs(relativeWidth)) * 3}px)`;
			}
			// 向左拖动区域小于40% 显示右侧文本描述
